...
export function ProductDetailPage() {
    ...
    return (
        <div className="w-full min-h-screen flex flex-col items-center bg-gray-50">
            <Header />
            <div className="w-5/6 md:w-2/3 lg:w-2/3 bg-white rounded-lg shadow-lg py-10 px-4 md:px-8 mt-12">
            ...
            <div className="w-5/6 md:w-2/3 lg:w-2/3 bg-white rounded-lg shadow-lg py-10 px-4 md:px-8 mt-12 mb-20">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    {loading
                        ...
                        : product.relatedProducts.map((relatedProduct, index: any) => (
                            <div key={index} className="bg-white shadow-md rounded-lg p-5 flex flex-col items-center hover:shadow-xl transition-shadow duration-300 ease-in-out">
                                <img
